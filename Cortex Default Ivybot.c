...
#pragma config(Motor,  port7,          RightDrive10,  tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,          RightDrive6,   tmotorVex393_MC29, openLoop)
...
if(vexRT[Btn5D]==1){
	motor[RightDrive10]   =  126;
	motor[RightDrive6]   =  126;}
if(vexRT[Btn6D]==1){
	motor[RightDrive10]   =  0;
	motor[RightDrive6]   =  0; }
    }
    //---------------------------------------------------------------------------------------------------------------------------------------------------------------------
